  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.success(`Found ${data.leads?.length || 0} companies!`)
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Lead Discovery</h1>
          <p className="text-gray-600 dark:text-gray-400">
            Find and qualify biotech companies worldwide
          </p>
        </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium text-gray-900 dark:text-white">
                  Searching companies... {isDemoMode ? '(Demo Mode)' : '(Production)'}
                </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Card className="bg-white dark:bg-gray-800">
            <CardContent className="p-4 text-center">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {discoveredLeads.filter(lead => (lead.ai_score || 0) >= 80).length}
              </p>
      ...
      {discoveredLeads.length > 0 && (
        <Card className="bg-white dark:bg-gray-800">
          <CardHeader>
            ...
            <CardDescription>Companies matching your search criteria</CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
              <TableHeader>
                    ...
                    <TableCell>
                      {lead.ai_score ? (
                        <div className="flex items-center space-x-2">
                          <Star className={`w-4 h-4 ${getScoreColor(lead.ai_score)}`} />
        ...
        <Card className="bg-white dark:bg-gray-800">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Configure your search criteria above and start discovering biotech companies
            </p>
