...
echo "🔧 Removing Local Toggle from Discovery Page..."
echo "=============================================="

# Update the discovery page to remove local toggle and use global demo context
echo "📝 Updating discovery page to use global demo toggle..."
...
export default function LeadDiscoveryPage() {
  // Use the global demo context instead of local state
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Mode Info Banner - Shows current global demo mode */}
      <Card className={`border-0 shadow-sm ${isDemoMode ? 'bg-blue-50 dark:bg-blue-900/20' : 'bg-green-50 dark:bg-green-900/20'}`}>
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            <Globe className={`w-5 h-5 ${isDemoMode ? 'text-blue-600 dark:text-blue-400' : 'text-green-600 dark:text-green-400'}`} />
            <div>
...
echo ""
echo "✅ Local Toggle Removed from Discovery Page!"
echo ""
echo "🔧 Changes Made:"
echo "  - Removed local demo/production toggle from discovery page header"
echo "  - Page now uses global demo context via useDemoMode() hook"
echo "  - Added mode info banner showing current global setting"
echo "  - Discovery page respects whatever the global toggle is set to"
echo ""
echo "🌐 Global Toggle Control:"
echo "  - Discovery page shows current mode: 'Demo Mode' or 'Production Mode'"
echo "  - Mode changes instantly when global toggle is switched"
echo "  - All functionality (search, save, display) respects global setting"
echo "  - No conflicts between local and global toggles"
echo ""
echo "📍 Mode Display:"
echo "  - Header subtitle shows current mode"
echo "  - Info banner explains what mode means"
echo "  - Progress bar shows mode during searches"
echo "  - Toast messages indicate demo vs production actions"
echo ""
echo "The discovery page will now work with your global toggle!"
