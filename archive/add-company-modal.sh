...
// Import the demo-aware Apollo service
...
export default function EnhancedLeadDiscoveryPage() {
    ...
    return (
        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="pt-2">
                                    <Button
                                        ...
                                        disabled={isCheckingExisting || isDemoMode}
            ...
            <Dialog open={showLeadDialog} onOpenChange={setShowLeadDialog}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                {selectedLead?.ai_score && (
                                    <Badge className={`ml-2 ${getScoreBadge(selectedLead.ai_score)}`}>
                        ...
                        <DialogDescription>
                            Complete company profile with contacts and funding information
                        </DialogDescription>
                    </DialogHeader>
                    ...
                    {selectedLead && (
                        <div className="space-y-6">
                                    ...
                                    <CardContent className="space-y-3">
                                        ...
                                        {selectedLead.foundedYear && (
                                            <div>
                                                ...
                                                <p className="font-medium">{selectedLead.foundedYear}</p>
                                            </div>
                                        )}
                                        {selectedLead.employeeCount && (
                                            <div>
                                                <p className="text-sm text-gray-500">Employees</p>
                                                <p className="font-medium">{selectedLead.employeeCount.toLocaleString()}</p>
                                            </div>
                                        )}
                                    </CardContent>
                                </Card>
                                    ...
                                    <CardContent className="space-y-3">
                                        {selectedLead.funding_info?.stage && (
                                            <div>
                                                ...
                                                <Badge variant="outline">{selectedLead.funding_info.stage}</Badge>
                                            </div>
                                        )}
                                        ...
                                        {selectedLead.latest_investors && (
                                            <div>
                                                <p className="text-sm text-gray-500">Latest Investors</p>
                                                <p className="text-sm">{selectedLead.latest_investors}</p>
                                            </div>
                                        )}
                                    </CardContent>
                                </Card>
                                            ...
                                            <div key={index} className="border rounded-lg p-4 space-y-3">
                                                <div className="flex items-start space-x-3">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <Badge
                                                            className={`${getRoleBadgeColor(contact.role_category)} text-xs mt-1`}
                                                        >
                                                            {contact.role_category}
                                                        </Badge>
                                                    </div>
                            ...
                            {/* All Investors */}
                            {selectedLead.all_investors && selectedLead.all_investors.length > 0 && (
                                <Card>
                                    <CardHeader>
                                    ...
                                    <CardContent>
                                        <div className="flex flex-wrap gap-2">
                                            {selectedLead.all_investors.map((investor, index) => (
            ...
            {/* Saved Prospects Modal */}
            <Dialog open={showSavedDialog} onOpenChange={setShowSavedDialog}>
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Saved Prospects ({savedProspects.length})</DialogTitle>
                        <DialogDescription>
                            Your previously saved companies and contacts
                        </DialogDescription>
                    </DialogHeader>
                    <div className="space-y-4">
                        {savedProspects.length > 0 ? (
                            savedProspects.map((prospect, index) => (
                                <div key={index} className="border rounded-lg p-4">
                                    <div className="flex items-start justify-between">
                                        <div>
                                            <h4 className="font-medium">
                                                {prospect.type === 'company' 
                                                    ? (prospect.data as DiscoveredLead).company
                                                    : (prospect.data as VCContact).name
                                                }
                                            </h4>
                                            <p className="text-sm text-gray-600">
                                                {prospect.type === 'company' 
                                                    ? (prospect.data as DiscoveredLead).industry
                                                    : (prospect.data as VCContact).organization
                                                }
                                            </p>
                                            <Badge variant="outline" className="mt-1">
                                                {prospect.type === 'company' ? 'Company' : 'VC/Investor'}
                                            </Badge>
                                        </div>
